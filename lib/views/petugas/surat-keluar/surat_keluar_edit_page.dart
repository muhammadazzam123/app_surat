...
class SuratKeluarEditPage extends StatefulWidget {
  const SuratKeluarEditPage({super.key, this.suratKeluar});

  final SuratKeluar? suratKeluar;

  @override
  State<SuratKeluarEditPage> createState() => _SuratKeluarEditPageState();
}

class _SuratKeluarEditPageState extends State<SuratKeluarEditPage> {
  final _formState = GlobalKey<FormState>();
  TextEditingController nomorTextController = TextEditingController();
  TextEditingController tujuanTextController = TextEditingController();
  ...
  TextEditingController pengolahTextController = TextEditingController();
  ...
  TextEditingController lembarTextController = TextEditingController();
  ...
  _setData() {
    nomorTextController.text = '${widget.suratKeluar!.noSurat}';
    tujuanTextController.text = '${widget.suratKeluar!.tujuanSurat}';
    perihalTextController.text = '${widget.suratKeluar!.perihalindexSk}';
    pembuatTextController.text = '${widget.suratKeluar!.pegawaiId}';
    tanggalController.text = '${widget.suratKeluar!.tglKeluar}';
    pengolahTextController.text = '${widget.suratKeluar!.pengolah}';
    lampiranTextController.text = '${widget.suratKeluar!.lampiran}';
    kodeTextController.text = '${widget.suratKeluar!.kodeSuratId}';
    lembarTextController.text = '${widget.suratKeluar!.lembar}';
    catatanTextController.text = '${widget.suratKeluar!.catatan}';
    isiTextController.text = '${widget.suratKeluar!.isiRingkas}';
    _fileName = '${widget.suratKeluar!.fileSk}';
  }
  ...
  void _editSuratKeluar() async {
    try {
      ...
      FormData suratData = FormData.fromMap({
        ...
        'catatan': catatanTextController.text,
        'tujuan_surat': tujuanTextController.text,
        'isi_ringkas': isiTextController.text,
        'lembar': lembarTextController.text,
        if (_suratFile != null)
          'file_sk': await MultipartFile.fromFile(_suratFile!.path,
              filename: _fileName),
        'lampiran': lampiranTextController.text,
        'tgl_keluar': dateFormat.parse(tanggalController.text),
        'perihalindex_sk': perihalTextController.text,
        'pengolah': pengolahTextController.text,
        'kode_surat_id': int.parse(kodeTextController.text),
        'pegawai_id': int.parse(pembuatTextController.text)
      });

      final Response response = await SuratKeluarService()
          .patchSuratKeluar(suratData, widget.suratKeluar!.id);

      if (response.statusCode == 200) {
        if (context.mounted) {
          Navigator.pushReplacementNamed(context, '/surat-keluar');
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          controller: tujuanTextController,
          decoration: InputDecoration(
            border: const OutlineInputBorder(
                borderRadius: BorderRadius.all(Radius.circular(10))),
            focusedBorder: OutlineInputBorder(
    ...
    return Column(
      ...
      children: [
        ...
        DropdownSearch<String>(
          ...
          selectedItem: widget.suratKeluar!.pegawai!.nama,
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          controller: pengolahTextController,
          decoration: InputDecoration(
            border: const OutlineInputBorder(
                borderRadius: BorderRadius.all(Radius.circular(10))),
            focusedBorder: OutlineInputBorder(
    ...
    return Column(
      ...
      children: [
        ...
        DropdownSearch<String>(
          ...
          selectedItem: widget.suratKeluar!.kodeSurat!.kode,
          popupProps: const PopupProps.menu(
            scrollbarProps:
                ScrollbarProps(thumbVisibility: true, thumbColor: Colors.amber),
            showSelectedItems: true,
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          controller: lembarTextController,
          keyboardType: TextInputType.number,
          decoration: InputDecoration(
            border: const OutlineInputBorder(
                borderRadius: BorderRadius.all(Radius.circular(10))),
