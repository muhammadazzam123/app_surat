...
class SuratKeluarTambahPage extends StatefulWidget {
  const SuratKeluarTambahPage({super.key});

  @override
  State<SuratKeluarTambahPage> createState() => _SuratKeluarTambahPageState();
}

class _SuratKeluarTambahPageState extends State<SuratKeluarTambahPage> {
  ...
  void _addSuratKeluar() async {
    try {
      ...
      final Response response =
          await SuratKeluarService().postSuratKeluar(suratData);
